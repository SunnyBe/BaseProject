...
object Dependencies {
    ...
    val fragment_ktx = "androidx.fragment:fragment-ktx:1.2.5"
    val lifecycle_runtime_ktx = "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.lifecycle_version}"
    val lifecycle_viewModel_savedstate = "androidx.lifecycle:lifecycle-viewmodel-savedstate:2.2.0"
    val kotlin_coroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.coroutines_version}"
    val kotlin_coroutines_common = "org.jetbrains.kotlinx:kotlinx-coroutines-core-common:${Versions.coroutines_version}"
    ...
    val lifecycle_livedata = "androidx.lifecycle:lifecycle-livedata-ktx:${Versions.livedata_version}"
