...
object NoteRepository {
    ...
    fun fetchAllNotes(): Flow<DataState<NoteViewState>> {
        return flow {
            ...
            val item = NoteEntity.Note("01", "first title", "content this is just a test content for the show, this is just a test content for the show")
            val item1 = NoteEntity.Note("02", "test title", "this is just a test content for the show, this is just a test content for the show, this is just a test content for the show")
            val item2 = NoteEntity.Note("03", "here title", "content for the show, dont mind this isa tes, this is just a test content for the show")
            val item3 = NoteEntity.Note("04", "another title", "content for the show, dont mind this isa tes, this is just a test content for the show. this is just a test content for the show")
